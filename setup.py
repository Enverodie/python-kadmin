...
# from kadmin.setup import setup as kadmin_setup
# from kadmin_local.setup import setup as kadmin_local_setup
...
#         name='kadmin-main',
#         version='0.0.3',
#         description='Python modules for kerberos admin (kadm5)',
...
#             Extension(
#                 "kadmin",
#                 libraries=["krb5", "kadm5clnt", "kdb5", "kadm5srv"],
